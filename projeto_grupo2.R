...
# f) Normalize between arrays and boxplots
...
M_array <- array(c(log2(patient1@spotData$Cy5/patient1@spotData$Cy3), log2(patient2@spotData$Cy5/patient2@spotData$Cy3), log2(patient3@spotData$Cy5/patient3@spotData$Cy3)),dim = c(2994,3))
boxplot(M_array,col=rainbow(6))

M_array_bg_normalized <- array(c(log2(normalized_bg_patient1@spotData$Cy5/normalized_bg_patient1@spotData$Cy3), log2(normalized_bg_patient2@spotData$Cy5/normalized_bg_patient2@spotData$Cy3), log2(normalized_bg_patient3@spotData$Cy5/normalized_bg_patient3@spotData$Cy3)),dim = c(2994,3))
...
MA_list_eBayes <- eBayes(MA_list_fit)
table<-topTable(MA_list_eBayes,number=20,adjust="BH")
table
